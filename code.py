...
async def guild(ctx, guild: discord.Guild = None):
    ...
    if ctx.guild.id in guilds:
        ...
        emb.add_field(name = 'Из них людей', value = len(list(filter(lambda member: not member.bot, guild.members))))
        emb.add_field(name = 'Из них машин', value = len(list(filter(lambda member: member.bot, guild.members))))
